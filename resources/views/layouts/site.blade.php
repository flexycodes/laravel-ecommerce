...
<head>
    ...
    <link rel="stylesheet"
          href="http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/cache/theme-77e2b824.css"
    ...
    <script type="text/javascript">
        ...
        var prestashop = {
            ...
            "urls": {
                ...
                "current_url": "http:\/\/demo.bestprestashoptheme.com\/savemart\/en\/",
                ...
                "alternative_langs": {
                    "en-us": "http:\/\/demo.bestprestashoptheme.com\/savemart\/en\/",
                    "fr-fr": "http:\/\/demo.bestprestashoptheme.com\/savemart\/fr\/",
                    "es-es": "http:\/\/demo.bestprestashoptheme.com\/savemart\/es\/",
                    "it-it": "http:\/\/demo.bestprestashoptheme.com\/savemart\/it\/",
                    "pl-pl": "http:\/\/demo.bestprestashoptheme.com\/savemart\/pl\/",
                    "ar-sa": "http:\/\/demo.bestprestashoptheme.com\/savemart\/ar\/"
                },
...
<main id="main-site" class="displayhomenovone">
    ...
    <header id="header" class="header-1 sticky-menu">
        ...
        @include('front.includes.headers.header-mobile')
        @include('front.includes.headers.header-top')
        @include('front.includes.headers.header-center')
        @include('front.includes.headers.header-bottom')
    ...
    @include('front.includes.footers.footer')
            ...
            <div>
                <div id="_mobile_account_list">
                    <div class="account-list-content">
                        <div>
                            <a class="login" href="http://demo.bestprestashoptheme.com/savemart/en/my-account"
                               rel="nofollow" title="Log in to your customer account"><i class="fa fa-sign-in"></i>Sign
                                in</a>
                        </div>
                        <div>
                            <a class="register" href="http://demo.bestprestashoptheme.com/savemart/en/my-account"
                               rel="nofollow" title="Register Account"><i class="fa fa-user"></i>Register Account</a>
                        </div>
                        <div>
                            <a class="check-out" href="http://demo.bestprestashoptheme.com/savemart/en/order"
            ...
            <div class="w-100">
                <div class="item-currency current">
                    <a title="British Pound" rel="nofollow"
                       href="http://demo.bestprestashoptheme.com/savemart/en/?SubmitCurrency=1&amp;id_currency=1">British
                        Pound: GBP</a>
                </div>
                <div class="item-currency">
                    <a title="US Dollar" rel="nofollow"
                       href="http://demo.bestprestashoptheme.com/savemart/en/?SubmitCurrency=1&amp;id_currency=2">US
                        Dollar: USD</a>
                </div>
            </div>
        </div>
        <div id="box-language" class="box-content d-flex">
            <div class="w-100">
                <div class="item-language current">
                    <a href="http://demo.bestprestashoptheme.com/savemart/en/" class="d-flex align-items-center"><img
                            class="img-fluid mr-2" src="{{ asset('assets/images/en.jpg') }}" alt="English (English)"
                            width="16" height="11"/><span>English</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/fr/" class="d-flex align-items-center"><img
                            class="img-fluid mr-2" src="{{ asset('assets/images/fr.jpg') }}" alt="Français (French)"
                            width="16" height="11"/><span>Français</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/es/" class="d-flex align-items-center"><img
                            class="img-fluid mr-2" src="{{ asset('assets/images/es.jpg') }}" alt="Español (Spanish)"
                            width="16" height="11"/><span>Español</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/it/" class="d-flex align-items-center"><img
                            class="img-fluid mr-2" src="{{ asset('assets/images/it.jpg') }}" alt="Italiano (Italian)"
                            width="16" height="11"/><span>Italiano</span></a>
                </div>
                <div class="item-language">
                    <a href="http://demo.bestprestashoptheme.com/savemart/ar/" class="d-flex align-items-center"><img
                            class="img-fluid mr-2" src="{{ asset('assets/images/ar.jpg') }}"
...
<div id="stickymenu_bottom_mobile" class="d-flex align-items-center justify-content-center hidden-md-up text-center">
    ...
    <div class="stickymenu-item"><a
            href="http://demo.bestprestashoptheme.com/savemart/en/module/novblockwishlist/mywishlist"><i
