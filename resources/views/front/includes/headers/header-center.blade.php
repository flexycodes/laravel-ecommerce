        ...
        <div class="row d-flex align-items-center">
            <div id="_desktop_logo"
                ...
                <a href="http://demo.bestprestashoptheme.com/savemart/">
                    <img class="logo img-fluid" src="{{ asset('public/assets/images/logo.png') }}"
                        ...
                        <div id="megamenu" class="nov-megamenu clearfix">
                            <ul class="menu level1">
                                <li class="item home-page has-sub">
                                    <span class="opener"></span><a href="?home" title="Home"><i
                                            class="zmdi zmdi-home"></i>Home</a>
                                    <div class="dropdown-menu" style="width:200px">
                                        <ul class="">
                                            <li class="item "><a href="?home=home_1" title="Homepage 1">Homepage 1</a>
                                            </li>
                                            <li class="item "><a href="?home=home_2" title="Homepage 2">Homepage 2</a>
                                            </li>
                                            <li class="item "><a href="?home=home_3" title="Homepage 3">Homepage 3</a>
                                            </li>
                                            <li class="item "><a href="?home=home_4" title="Homepage 4">Homepage 4</a>
                                            </li>
                                            <li class="item "><a href="?home=home_5" title="Homepage 5">Homepage 5</a>
                                            </li>
                                            <li class="item "><a href="?home=home_6" title="Homepage 6">Homepage 6</a>
                                            </li>
                                            <li class="item "><a href="?home=home_7" title="Homepage 7">Homepage 7</a>
                                            </li>
                                            <li class="item "><a href="?home=home_8" title="Homepage 8">Homepage 8</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="item  has-sub">
                                    <span class="opener"></span><a href="#" title="Blog"><i
                                    ...
                                    <div class="dropdown-menu" style="width:270px">
                                        <ul class="">
                                            ...
                                            <li class="item "><a
                                                    ...
                                                    title="Category Blog ( One column)">Category Blog ( One column)</a>
                                            </li>
                                            <li class="item "><a
                                                    href="/savemart/blog.html?index.php&amp;cateblog_layout=layout-one-column&amp;cateblog_type=grid&amp;cateblog_columns=3"
                                                    title="Category Blog ( Grid  column )">Category Blog ( Grid column
                                                    )</a></li>
                                            <li class="item "><a
                                ...
                                <li class="item menu-page group">
                                    <span class="opener"></span><a href="index.php?controller=sitemap" title="Pages"><i
                                                ...
                                                <div class="dropdown-menu">
                                                    <ul class="">
                                                        ...
                                                        <li class="item col-md-3 mw-40 html">
                                                            <div class="menu-content">
                                                                <div class="menu-banner-3 text-center"><a href="#"><img
                                                                            class="img-fluid"
                                ...
                                <li class="item  group">
                                    <span class="opener"></span><a
                                        href="http://demo.bestprestashoptheme.com/savemart/en/2-home"
                                                        ...
                                                        <li class="item col-lg-3 col-md-3 html">
                                                            ...
                                                            <div class="menu-content">
                                                                <ul class="col">
                                                                    ...
                                                                    <li><a href="#" title="Lenovo Yoga">Lenovo Yoga</a>
                                                                    </li>
                                                                    ...
                                                                    <li><a href="#" title="Dell Alienware">Dell
                                                                            Alienware</a></li>
                                                                    <li><a href="#" title="HP Pavilion">HP Pavilion</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </li>
            ...
            <div class="contentsticky_group col-lg-3 col-md-3 d-flex justify-content-end align-items-center">
                <div class="header_link_myaccount">
                    <a class="login" href="http://demo.bestprestashoptheme.com/savemart/en/my-account" rel="nofollow"
                       title="Log in to your customer account"><i class="header-icon-account"></i></a>
                </div>
