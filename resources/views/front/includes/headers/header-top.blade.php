            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex justify-content-end align-items-center header-top-right">
                    <div class="register-out">
                        ...
                        <a class="register"
                           href="http://demo.bestprestashoptheme.com/savemart/en/login?create_account=1"
                           data-link-action="display-register-form">
                            Register
                        </a>
                        <span class="or-text">or</span>
                        <a class="login" href="http://demo.bestprestashoptheme.com/savemart/en/my-account"
                           rel="nofollow" title="Log in to your customer account">Sign in</a>
                    </div>
                            ...
                            <div class="currency-list-content text-left">
                                <div class="currency-item current flex-first">
                                    <a title="British Pound" rel="nofollow"
                                       href="http://demo.bestprestashoptheme.com/savemart/en/?SubmitCurrency=1&amp;id_currency=1">£
                                        GBP</a>
                                </div>
                                <div class="currency-item">
                                    <a title="US Dollar" rel="nofollow"
                                       href="http://demo.bestprestashoptheme.com/savemart/en/?SubmitCurrency=1&amp;id_currency=2">$
                                        USD</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="_desktop_language_selector"
                        ...
                        <div class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            ...
                            <span class="expand-more"><img class="img-fluid"
                                                           src="{{ asset('assets/images/en.jpg') }}"
                                                           alt="English"
                                ...
                                <div class="language-item current flex-first">
                                    <div class="current">
                                        <a href="http://demo.bestprestashoptheme.com/savemart/en/">
                                            <img class="img-fluid" src="{{ asset('assets/images/en.jpg') }}"
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/fr/">
                                            <img class="img-fluid" src="{{ asset('assets/images/fr.jpg') }}"
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/es/">
                                            <img class="img-fluid" src="{{ asset('assets/images/es.jpg') }}"
                                                 alt="Español" width="16"
                                                 height="11"/>
                                            <span>Español</span>
                                        </a>
                                    </div>
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/it/">
                                            <img class="img-fluid" src="{{ asset('assets/images/it.jpg') }}"
